...
export function createRecoveryCode() { return randomBytes(10).toString("hex").toUpperCase().match(/.{1,4}/g)?.join("-") ?? randomUUID().slice(0, 12).toUpperCase(); }
