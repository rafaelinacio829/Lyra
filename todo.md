...
- [x] Adicionar observabilidade operacional de produção com alertas de erros, disponibilidade de integrações e trilha de incidentes.
...
- [x] Persistir incidentes operacionais sem segredos, com severidade, deduplicação, resolução e visualização exclusiva de super-admin.
